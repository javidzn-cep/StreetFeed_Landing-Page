...
let 
    cursorX, cursorY, rollBarTransaltePerc, cursorRollBarTransaltePerc,
    currentMaskSize, maskSizeIsHovering, mapboxMap, movingMapFrame, movingMapFrameDiference,
    searchBoxTimeoutID, modalConfirmatedCenter;
